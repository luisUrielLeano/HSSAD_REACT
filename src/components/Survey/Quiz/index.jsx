...
const Quiz = ({ completeQuiz }) => {
    ...
    return (
        <S.QuestionsWrapper>
            ...
            { !isCompleted && count===5 && <Button onClick={ handleNextSection }color={'#0000CC'}>Continuar</Button> }
            { isCompleted && count===5 && <Button onClick={ handleFinish }color={'#0000CC'}>Terminar</Button> }
        </S.QuestionsWrapper>
    );
};
